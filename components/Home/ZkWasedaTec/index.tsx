...
export default function ZkWaseda(router: any) {
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="space-y-6">
              {projects.map((project, index) => (
                <Link key={project} href="/wtec" className="flex items-center p-6 bg-second rounded-xl hover:bg-second/60 transition-colors cursor-pointer">
                  <div
                    ...
                    className="flex items-center bg-second rounded-xl hover:bg-second/60 transition-colors cursor-pointer"
                  >
