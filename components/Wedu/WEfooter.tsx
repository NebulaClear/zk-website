...
//   });
  ...
  return (
    <section className="wefooter-section min-h-[400px] md:min-h-[450px] flex items-center bg-blue-600">
      <div className="container mx-auto px-4">
        {/* 移除初始opacity-0，改由GSAP控制 */}
        <div className="wefooter-content text-center max-w-3xl mx-auto">
