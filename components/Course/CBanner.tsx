...
export default function CourseSection() {
  ...
  useGSAP(() => {
    ...
    tl.fromTo(".content-animate",
      ...
      { 
        ...
        ease: "power3.out",
        // 解决移动端字体渲染问题
        onStart: () => document.body.classList.add('animate-active')
      }
    )
    .fromTo(".image-animate",
      { opacity: 0, x: 50 },
      { opacity: 1, x: 0, duration: 1, ease: "expo.out" },
      "<+0.2"
    )
    .fromTo(".button-animate",
      { scale: 0.8, opacity: 0 },
  ...
  return (
    <section className="course-section min-h-fit md:h-[600px] bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      <div className="container mx-auto px-4 py-12 md:py-24 flex flex-col md:flex-row items-center">
        {/* 文字内容区域 */}
        <div className="content-animate md:w-1/2 mb-12 md:mb-0 md:pr-8 pt-[60px] md:pt-0">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-blue-900 mb-6 leading-tight flex-shrink-0">
            专业日本留学课程体系
          </h1>
        ...
        <div className="image-animate md:w-1/2 relative h-64 md:h-auto">
          ...
          <Image
            src="/image/schools/waseda.jpg" // 替换为实际图片路径
